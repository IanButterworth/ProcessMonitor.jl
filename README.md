...
- `recursive=true` sums CPU time over the whole process subtree, which is usually where
  utilization above 100% comes from (a parent that mostly waits on busy children).
